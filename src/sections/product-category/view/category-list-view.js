...
import ExportToExcelcategory from '../category-export-excel';
...
function CategoryListView() {
  ...
  const handleEditRow = useCallback(
    (id) => {
      router.push(paths.dashboard.product.categoryedit(id));
    },
    [router]
  );
      ...
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Category list', href: paths.dashboard.product.root },
            // { name: 'Group' },
          ]}
          action={
            <Button
              component={RouterLink}
              href={paths.dashboard.product.categorynew}
              variant="contained"
        ...
        />
        <div>
          <ExportToExcelcategory data={dataFiltered} filename="Group_Data" />
          <Button
            onClick={exportToPDF}
            style={divStyle}
