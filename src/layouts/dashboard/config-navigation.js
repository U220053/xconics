      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          // USER
          {
            ...
            icon: ICONS.user,
            children: [
              { title: t('User Group Permission '), path: paths.dashboard.user.root },
              { title: t('User Master'), path: paths.dashboard.user.cards },
              { title: t('User Group Master'), path: paths.dashboard.user.list },
